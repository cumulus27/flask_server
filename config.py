...
class Config:
    ...
    FLASKY_MAIL_SUBJECT_PREFIX = '[Contrail]'
    FLASKY_MAIL_SENDER = os.environ.get('FLASK_MAIL_SENDER', 'contrail<contrail_server@163.com>')
...
class ProductionConfig(Config):
    ...
    def init_app(cls, app):
        ...
        if getattr(cls, 'MAIL_USERNAME', None) is not None:
            ...
            if getattr(cls, 'MAIL_USE_TLS', None) or getattr(cls, 'MAIL_USE_SSL', None):
                secure = ()
